...
Метод класса для выборки данных из БД по полю C<$field>, которое может принимать значения/значение C<$keys>. Параметр C<$limit> определяет лимит выборки, при запросах в БД по неуникальному ключу.
