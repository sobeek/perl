...
Значение атрибута может быть автоматически сгененрировано путем определения в наследниках метода C<_build_connection_params>, который должен возвращать ссылку на массив с параметрами.
