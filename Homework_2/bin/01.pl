...
=head
На вход функции подается список участников. Каждый аргумент - либо имя
холостого участника, либо ссылка на массив из имён супружеской пары. Имена
уникальны.

Программа должна случайно выбрать пары даритель -> получатель для всех
участников по следующим правилам:

Никто не дарит подарок сам себе.
Никто не дарит подарок своему супругу.
Два участника не дарят подарок друг другу.

Результатом функции должен быть список ссылок на массив из пар даритель ->
получатель
=cut
